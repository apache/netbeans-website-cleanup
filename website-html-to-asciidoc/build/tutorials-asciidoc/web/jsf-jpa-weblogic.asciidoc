...
:keywords: Apache NetBeans  jsf-jpa-weblogic
:description: Apache NetBeans  jsf-jpa-weblogic
:toc: left
:toc-title:
...
* link:#01[Registering the Oracle WebLogic Server]
* link:#01a[Installing the Server]
* link:#01b[Registering the Server with the IDE]
* link:#01c[Opening the Admin Console]
* link:#01e[Enabling Support for JPA 2.0]
* link:#02[Creating the Web Application Project]
* link:#02b[Creating the Database Connection]
* link:#02c[Creating the Persistence Unit]
* link:#02d[Creating the Entity Classes]
* link:#02e[Generating JSF Pages]
* link:#02f[Running the Application]
...
*Note.* If you are registering an instance of WebLogic Server 12c (12.1.1.0) you do not need to enable JPA 2.0 because JPA 2.0 is enabled by default. If you are registering an instance of WebLogic Server 11g Rel 1 (10.3.4 or 10.3.5) you can enable JPA 2.0 when you register the server or in the Servers manager after the server is registered. See the section link:#01e[Enabling Support for JPA 2.0 on Oracle WebLogic Server 11g] below for more details.
