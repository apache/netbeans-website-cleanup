...
= jsf-jpa-weblogic_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  jsf-jpa-weblogic_pt_BR
:description: Apache NetBeans  jsf-jpa-weblogic_pt_BR
:toc: left
:toc-title:
...
* link:#01[Registrando o Oracle WebLogic Server]
* link:#01a[Instalando o Servidor]
* link:#01b[Registrando o Servidor com o IDE]
* link:#01c[Abrindo a Console de Administração]
* link:#01e[Ativando o Suporte para JPA 2.0]
* link:#02[Criando o Projeto de Aplicação Web]
* link:#02b[Criando a Conexão de Banco de Dados]
* link:#02c[Criando a Unidade de Persistência]
* link:#02d[Criando as Classes de Entidade]
* link:#02e[Gerando Páginas JSF]
* link:#02f[Executando a Aplicação]
...
image:weblogic-services-window1.png[title="WebLogic Server na janela Serviços"]
...
image:admin-console1.png[title="Console de Administração do Oracle WebLogic Server"]
...
image:weblogic-properties-enablejpa.png[title="Guia Domínio do Gerenciador de servidores"]
...
image:admin-console-jpa.png[title="guia JPA na Console de Administração do Oracle WebLogic Server"]
...
image:new-project-ee6.png[title="WebLogic selecionado no Assistente de Novo Projeto"]
...
image:projectwizard-serverlib.png[title="Painel Frameworks do assistente de Novo Projeto"]
...
image:wl-projects-window1.png[title="weblogic.xml selecionado na janela Projetos"]
...
image:install-libraries-dialog.png[title="Caixa de diálogo Resolver Problema de Biblioteca do Servidor não Encontrada"]
...
image:create-db.png[title="Caixa de diálogo Criar Banco de Dados"]
...
image:services-window2.png[title="Nó do banco de dados de amostra na janela Serviços"]
...
image:new-persistence-eclipselink1.png[title="Assistente Nova Unidade de Persistência"]
...
image:browser-welcome.png[title="Página de boas-vindas no browser"]
...
image:adminconsole-deployments.png[title="Tabela de Implantações na Console de Administração do WebLogic Server"]
...
image:admin-console-deployments.png[title="Tabela de Implantações na Console de Administração do WebLogic Server"]
...
image:weblogic-services-window2.png[title="Aplicações e recursos do WebLogic Server na janela Serviços"]
