...
= quickstart-webapps-spring_ru
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  quickstart-webapps-spring_ru
:description: Apache NetBeans  quickstart-webapps-spring_ru
:toc: left
:toc-title:
...
* link:#setting[Создание проекта с поддержкой веб-модели MVC Spring]
* link:#creating[Создание схемы проекта с поддержкой веб-модели MVC Spring]
* link:#running[Выполнение схемы проекта]
* link:#overview[Обзор приложения]
* link:#service[Реализация службы]
* link:#controller[Реализация контроллера и модели]
* link:#view[Реализация представлений]
...
image:frameworks-window.png[title="Spring Web MVC отображается на панели палтформы"]
...
image:spring-configuration.png[title="Укажите имя и сопоставление сервлета Spring Dispatcher на вкладке 'Конфигурация'"]
...
image:browser-output.png[title="Выходные данные страницы приветствия отображаются в браузере"]
...
1. Нажмите кнопку 'Создать файл' (image:new-file-btn.png[]) на панели инструментов IDE. (В качестве альтернативы нажмите Ctrl-N; ⌘-N в Mac.)
...
image:simple-form-controller.png[title="IDE NetBeans обеспечивает шаблоны для различных артефактов Spring"]
...
image:comment-out.png[title="Выделите фрагменты кода, затем нажмите Ctrl-/ для переключения комментариев"]
...
image:set-command-class.png[title="Метка ошибки отображается для setCommandClass()"]
...
image:generate-code.png[title="Всплывающее меню создания кода позволяет настроить методы доступа"]
...
image:fix-imports70.png[title="Нажмите Ctrl-Shift-I, чтобы исправить выражения импорта в файле"]
...
image:code-completion.png[title="Автозавершение кода вызывается при нажатии Ctrl-Space"]
...
----
4. link:#create-jsp[Тем же способом] создайте вторую страницу JSP и назовите ее `nameView`.
...
image:name-view.png[title="nameView отображается в браузере"]
Введите имя в текстовом поле и нажмите ENTER. Отображается `helloView` с приветственным сообщением:
image:hello-view.png[title="helloView отображается в браузере"]
