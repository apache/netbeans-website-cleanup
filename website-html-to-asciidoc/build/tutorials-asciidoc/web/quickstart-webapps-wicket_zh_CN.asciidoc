...
= quickstart-webapps-wicket_zh_CN
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  quickstart-webapps-wicket_zh_CN
:description: Apache NetBeans  quickstart-webapps-wicket_zh_CN
:toc: left
:toc-title:
...
* link:#setup[设置环境]
* link:#creating[创建 Wicket 应用程序的源代码结构]
* link:#create-1[方案 1：从头开始创建基于 Ant 的 Wicket 应用程序]
* link:#create-2[方案 2：从头开始创建基于 Maven 的 Wicket 应用程序]
* link:#create-3[方案 3：根据原型创建基于 Maven 的 Wicket 应用程序]
* link:#create-4[方案 4：将 Wicket 支持添加到现有应用程序中]
* link:#libraries[提供对 Wicket 的替代版本的支持]
* link:#examining[检查生成的 Wicket 应用程序的源代码结构]
* link:#features[使用 Wicket 功能]
* link:#widget[添加窗口部件]
* link:#component[添加可重用组件]
* link:#ajax[添加 AJAX 功能]
* link:#next[后续步骤]
* link:#seeAlso[另请参见]
