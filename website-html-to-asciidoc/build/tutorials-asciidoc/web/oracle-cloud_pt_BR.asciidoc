...
:keywords: Apache NetBeans  oracle-cloud_pt_BR
:description: Apache NetBeans  oracle-cloud_pt_BR
:toc: left
:toc-title:
...
* link:#sdk-download[Fazendo Download do Oracle Java Cloud Service SDK]
* link:#install-plugin[Instalar o Plug-in do Oracle Cloud]
* link:#register-cloud[Registrando o Oracle Cloud no IDE]
* link:#jobs-n-logs[Exibindo Jobs e Logs]
* link:#remote-server[Servidor Oracle Cloud Remote]
* link:#cloud-vs-local[Desenvolvendo Aplicações em uma Máquina Local]
* link:#create-webapp[Criando uma Aplicação Web]
* link:#crud[Criando uma Aplicação CRUD com JSF]
* link:#test-whitelist[Testando Suporte à Lista de Permissão]
...
1. Na janela Projetos, clique com o botão direito do mouse nalink:#create-webapp[aplicação web criada] e selecione Novo > Servlet. O assistente Novo Servlet será aberto.
