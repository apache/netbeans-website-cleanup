...
:keywords: Apache NetBeans  applets_zh_CN
:description: Apache NetBeans  applets_zh_CN
:toc: left
:toc-title:
...
* link:#create[创建或导入小应用程序]
* link:#runanddebug[运行小应用程序]
* link:#embed[在 Web 应用程序中嵌入小应用程序]
...
4. 单击 "Finish"（完成）。如果已导入一个小应用程序源文件，则link:#runanddebug[运行该文件]。
