...
= gui-image-display_zh_CN
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  gui-image-display_zh_CN
:description: Apache NetBeans  gui-image-display_zh_CN
:toc: left
:toc-title:
...
* link:#form[创建应用程序窗体]
* link:#package[为图像添加包]
* link:#displaying[在标签上显示图像]
* link:#building[构建和运行应用程序]
* link:#background[将图像显示为框架上的背景]
* link:#custom[创建定制代码]
* link:#summary[小结]
* link:#seealso[另请参见]
