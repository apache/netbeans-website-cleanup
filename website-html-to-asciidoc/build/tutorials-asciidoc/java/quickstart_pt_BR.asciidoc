...
image:netbeans-stamp-80-74-73.png[title="O conteúdo desta página se aplica ao NetBeans IDE 7.2 e versões posteriores"]

* link:#setup[Configurando o Projeto]
* link:#code[Adicionando Código ao Arquivo de Origem Gerado]
* link:#run[Compilando e Executando a Aplicação]
* link:#build[Construindo e Implantando a Aplicação]
