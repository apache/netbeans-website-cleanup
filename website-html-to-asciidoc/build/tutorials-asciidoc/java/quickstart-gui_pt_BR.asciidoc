...
= quickstart-gui_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  quickstart-gui_pt_BR
:description: Apache NetBeans  quickstart-gui_pt_BR
:toc: left
:toc-title:
...
* link:#getting_started[Conceitos Básicos]
* link:#project[Criando um Projeto]
* link:#container[Criando um Contêiner JFrame]
* link:#getting_familiar[Familiarizando-se com o GUI Builder]
* link:#key_concepts[Conceitos-Chave]
* link:#design[Design Livre]
* link:#snapping[Posicionamento Automático do Componente (Encaixe)]
* link:#feedback[Feedback Visual]
* link:#first_things[Primeiro o Principal]
* link:#adding_components[Adicionando Componentes: Conceitos Básicos]
* link:#individual[Adicionando Componentes Individuais ao Form]
* link:#multiple[Adicionando Vários Componentes ao Form]
* link:#inserting[Inserindo Componentes]
* link:#moving_forward[Avançando]
* link:#aligning_components[Alinhamento de Componentes]
* link:#baseline_alignment[Alinhamento da Linha de Base]
* link:#reviewing[Revisando o Que Aprendemos]
* link:#adding_aligning_anchoring[Adicionando, Alinhando e Ancorando]
* link:#component_sizing[Dimensionamento de Componentes]
* link:#indentation[Recuo]
* link:#adjusting_form[Fazendo os Ajustes Finais]
* link:#previewing_form[Visualizando a GUI]
* link:#deploying[Implantando Aplicações GUI]
...
2. Clique no botão Alinhar à Direita na coluna (image:align_r.png[]) na barra de ferramentas. Alternativamente, clique com o botão direito do mouse em um deles e escolha Alinhar > Direita na coluna no menu pop-up.
...
Agora que você criou com êxito a GUI ContactEditor, é possível experimentar a interface para ver os resultados. É possível visualizar o form à medida que trabalha clicando no botão Visualizar Form (image:test_form.png[]) na barra de ferramentas do GUI Builder. O form será aberto em sua própria janela, permitindo que você o teste antes da construção e execução.
