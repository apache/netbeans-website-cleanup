...
:keywords: Apache NetBeans  gui-functionality
:description: Apache NetBeans  gui-functionality
:toc: left
:toc-title:
...
* link:#Exercise_1[Exercise 1: Creating a Project]
* link:#Exercise_2[Exercise 2: Building the Front End]
* link:#Exercise_3[Exercise 3: Adding Functionality]
* link:#Exercise_4[Exercise 4: Running the Program]
* link:#how[How Event Handling Works]
...
*Note:* The location of the `NumberAddition` project directory depends on the path you specified while creating the project in step 3 of the link:#Exercise_1[Exercise 1: Creating a Project] section.
