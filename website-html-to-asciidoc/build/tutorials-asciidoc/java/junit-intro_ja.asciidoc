...
:keywords: Apache NetBeans  junit-intro_ja
:description: Apache NetBeans  junit-intro_ja
:toc: left
:toc-title:
...
* link:#Exercise_10[プロジェクトの作成]
* link:#Exercise_11[Javaクラス・ライブラリ・プロジェクトの作成]
* link:#Exercise_12[ソリューション・プロジェクトのダウンロード]
* link:#Exercise_13[Javaクラスの作成]
* link:#Exercise_20[JUnit 3テストの記述]
* link:#Exercise_21[`Vectors.java`用のテスト・クラスの作成]
* link:#Exercise_22[`Vectors.java`用のテスト・メソッドの記述]
* link:#Exercise_23[`Utils.java`用のテスト・クラスの作成]
* link:#Exercise_24[`Utils.java`用のテスト・メソッドの記述]
* link:#Exercise_25[テストの実行]
* link:#Exercise_30[JUnit 4テストの記述]
* link:#Exercise_31[`Vectors.java`用のテスト・クラスの作成]
* link:#Exercise_32[`Vectors.java`用のテスト・メソッドの記述]
* link:#Exercise_33[`Utils.java`用のテスト・クラスの作成]
* link:#Exercise_34[`Utils.java`用のテスト・メソッドの記述]
* link:#Exercise_35[テストの実行]
* link:#Exercise_40[JUnitテスト・スイートの作成]
* link:#Exercise_41[JUnit 3テスト・スイートの作成]
* link:#Exercise_42[JUnit 4テスト・スイートの作成]
* link:#Exercise_43[テスト・スイートの実行]
* link:#Exercise_50[サマリー]
...
image:projects-window.png[title="「プロジェクト」ウィンドウ内のJUnit-SampleおよびJUnitSampleSolプロジェクト"]
...
image:junit3-vectors-createtests.png[title="「JUnitのバージョンを選択」ダイアログ・ボックス"]
5. 「JUnitのバージョンを選択」ダイアログ・ボックスで「JUnit 3.x」を選択します。
image:junit3-select-version.png[title="「JUnitのバージョンを選択」ダイアログ・ボックス"]
...
image:projects-window2.png[title="「プロジェクト」ウィンドウ内のJUnit-Sampleプロジェクトの構造"]
...
比較: link:#Exercise_32[`Vectors.java`用のテスト・メソッドの記述(JUnit 4)]
...
比較: link:#Exercise_342[単純なアサーションを使用したテスト(JUnit 4)]
...
比較: link:#Exercise_343[タイム・アウトを使用したテスト(JUnit 4)]
...
比較: link:#Exercise_344[予想される例外のテスト(JUnit 4)]
...
比較: link:#Exercise_345[テストの無効化(JUnit 4)]
...
link:junit3-test-pass.png[image:junit3-test-pass-sm.png[title="テストに合格したことを示す「JUnitテスト結果」ウィンドウ。クリックすると大きいイメージが表示されます。"]]
...
link:junit3-test-fail.png[image:junit3-test-fail-sm.png[title="テストに失敗したことを示す「JUnitテスト結果」ウィンドウ。クリックすると大きいイメージが表示されます。"]]
...
単体テスト・クラス作成後の次の手順は、テスト・スイートの作成です。指定されたテストをグループとして実行し、各テストを個々に実行しなくて済むようにする方法については、link:#Exercise_41[JUnit 3テスト・スイートの作成]を参照してください。
...
3. 「フレームワーク」ドロップダウン・リストで「JUnit」を選択します。
4. 「テスト初期化」および「テスト終了」を選択解除します。「OK」をクリックします。
image:junit4-vectors-createtests.png[title="JUnit 4の「テストを作成」ダイアログ・ボックス"]
5. 「JUnitのバージョンを選択」ダイアログ・ボックスで「JUnit 4.x」を選択します。「選択」をクリックします。
image:junit4-select-version.png[title="「JUnitのバージョンを選択」ダイアログ・ボックス"]

「OK」をクリックすると、IDEによって、「プロジェクト」ウィンドウ内の「テスト・パッケージ」ノードの下にある`sample`パッケージ内に`VectorsJUnit4Test.java`テスト・クラスが作成されます。

image:projects-window3.png[title="JUnit 3およびJUnit 4テスト・クラスを含むJUnit-Sampleプロジェクトの構造"]
...
比較: link:#Exercise_22[`Vectors.java`用のテスト・メソッドの記述(JUnit 3)]
...
比較: link:#Exercise_241[テストの初期化および終了(JUnit 3)]
...
比較: link:#Exercise_242[単純なアサーションを使用したテスト(JUnit 3)]
...
比較: link:#Exercise_243[タイム・アウトを使用したテスト(JUnit 3)]
...
比較: link:#Exercise_244[予想される例外のテスト(JUnit 3)]
...
比較: link:#Exercise_245[テストの無効化(JUnit 3)]
...
link:junit4-utilstest-pass.png[image:junit4-utilstest-pass-sm.png[title="テストに合格したことを示す「JUnitテスト結果」ウィンドウ。クリックすると大きいイメージが表示されます。"]]
...
単体テスト・クラス作成後の次の手順は、テスト・スイートの作成です。指定されたテストをグループとして実行し、各テストを個々に実行しなくて済むようにする方法については、link:#Exercise_42[JUnit 4テスト・スイートの作成]を参照してください。
...
image:junit-testsuite-wizard.png[title="JUnitのテスト・スイート・ウィザード"]
...
link:junit3-suite-results.png[image:junit3-suite-results-sm.png[title="JUnit 3テスト・スイートの結果を示す「JUnitテスト結果」ウィンドウ。クリックすると大きいイメージが表示されます。"]]
...
link:junit4-suite-results.png[image:junit4-suite-results-sm.png[title="JUnit 4テスト・スイートの結果を示す「JUnitテスト結果」ウィンドウ。クリックすると大きいイメージが表示されます。"]]
...
link:junitmix3and4-suite-results.png[image:junitmix3and4-suite-results-sm.png[title="混合型のテスト・スイートの結果を示す「JUnitテスト結果」ウィンドウ。クリックすると大きいイメージが表示されます。"]]
