...
:keywords: Apache NetBeans  quickstart-gui
:description: Apache NetBeans  quickstart-gui
:toc: left
:toc-title:
...
* link:#project[Creating a Project]
* link:#container[Creating a JFrame Container]
* link:#getting_familiar[Getting Familiar with the GUI Builder]
* link:#key_concepts[Key Concepts]
* link:#design[Free Design]
* link:#snapping[Automatic Component Positioning (Snapping)]
* link:#feedback[Visual Feedback]
* link:#first_things[First Things First]
* link:#adding_components[Adding Components: The Basics]
* link:#individual[Adding Individual Components to the Form]
* link:#multiple[Adding Multiple Components to the Form]
* link:#inserting[Inserting Components]
* link:#moving_forward[Moving Forward]
* link:#aligning_components[Component Alignment]
* link:#baseline_alignment[Baseline Alignment]
* link:#reviewing[Reviewing What We've Learned]
* link:#adding_aligning_anchoring[Adding, Aligning, and Anchoring]
* link:#component_sizing[Component Sizing]
* link:#indentation[Indentation]
* link:#adjusting_form[Making the Final Adjustments]
* link:#previewing_form[Previewing Your GUI]
* link:#deploying[Deploying GUI Applications]
...
|link:http://netbeans.org/downloads/index.html[NetBeans IDE] |version 6.9 and more recent 
...
link:/about/contact_form.html?to=3&subject=Feedback:%20Designing%20a%20Swing%20GUI%20in%20NetBeans%20IDE[Send Feedback on This Tutorial]


=== See Also

You have now completed the Designing a Swing GUI tutorial. For information on adding functionality to the GUIs that you create, see:

* link:gui-functionality.html[Introduction to GUI Building]
* link:gui-image-display.html[Handling Images in a GUI Application]
* link:http://wiki.netbeans.org/wiki/view/NetBeansUserFAQ#section-NetBeansUserFAQ-GUIEditorMatisse[GUI Builder FAQ]
