...
:keywords: Apache NetBeans  javase-embedded_ja
:description: Apache NetBeans  javase-embedded_ja
:toc: left
:toc-title:
...
* link:#remote[NetBeans IDEでのリモート・プラットフォームの設定]
* link:#calculator[IDEでのプロジェクトの作成および実行]
* link:#project[リモート・プラットフォームを使用するプロジェクトの構成]
* link:#use[リモート・プラットフォームでのプロジェクトの実行]
* link:#see[関連項目]
