...
:keywords: Apache NetBeans  javase-intro_zh_CN
:description: Apache NetBeans  javase-intro_zh_CN
:toc: left
:toc-title:
...
* link:#setup[项目设置]
* link:#create[创建和编辑 Java 源代码]
* link:#comp[编译并运行应用程序]
* link:#test[测试和调试应用程序]
* link:#build[构建、运行和分发应用程序]
* link:#other-tasks[其他常见任务]
* link:#nextsteps[后续步骤]
...
3. 指示用户按照上面的link:#running-outside-IDE[在 IDE 外部运行应用程序]部分中的步骤进行操作。
