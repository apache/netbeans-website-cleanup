...
= jmx-manager-tutorial_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  jmx-manager-tutorial_pt_BR
:description: Apache NetBeans  jmx-manager-tutorial_pt_BR
:toc: left
:toc-title:
...
* link:#Exercise_1[Criando o Projeto de Anagrama de Amostra de Gerenciamento]
* link:#Exercise_2[Executando o Agente]
* link:#Exercise_3[Criando o Projeto do Gerenciador]
* link:#Exercise_3[Criando o Projeto]
* link:#Exercise_4[Criando a Classe do Gerenciador Executável]
* link:#Exercise_5[Executando o Gerenciador]
...
image:jmx-newproject.png[title="Jogo de Anagramas Gerenciado com o JMX no assistente Novo Projeto"]
...
image:jmx-properties1.png[title="Categoria Monitoramento e Gerenciamento na caixa de diálogo Propriedades do projeto"]
...
Se preferir, clique no botão Executar Projeto Principal com Monitoramento e Gerenciamento na barra de ferramentas (  image:run-project24.png[title="Botão Executar Projeto Principal com Monitoramento e Gerenciamento"]).
...
image:jmx-newjavaproject.png[title="Assistente Novo Projeto Java"]
...
image:jmx-newjmxmanager.png[title="O modelo do Gerenciador JMX no assistente Novo Arquivo"]
...
image:jmx-jmxagenturl.png[title="valores default na caixa de diálogo URL do Agente JMX do RMI"]
...
link:jmx-jmxagenturl2.png[image:jmx-jmxagenturl2-sm.png[title="Clique para aumentar"]]
