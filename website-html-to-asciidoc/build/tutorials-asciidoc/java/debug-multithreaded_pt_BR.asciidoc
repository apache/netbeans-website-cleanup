...
= debug-multithreaded_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  debug-multithreaded_pt_BR
:description: Apache NetBeans  debug-multithreaded_pt_BR
:toc: left
:toc-title:
...
* link:#Exercise_00[Fazendo Download de Projetos de Amostra]
* link:#Exercise_10[Abrindo os Projetos de Amostra]
* link:#Exercise_11[Executando o Projeto Gallery]
* link:#Exercise_12[Executando o Projeto Deadlock]
* link:#Exercise_20[Depurando os Projetos de Amostra]
* link:#Exercise_21[Suspendendo Threads]
* link:#Exercise_22[Alternando Threads]
* link:#Exercise_23[Detectando Deadlocks]
...
image:debugging-gallery-app.png[title="Aplicação Gallery"]
...
image:debugging-start.png[title="Janela de Depuração"]
...
image:debugging-start-suspend.png[title="Depurando janela com dois threads suspensos"]
...
image:debugging-window-toolbar.png[title="Barra de ferramentas de depuração"]
...
image:debugging-newbreakpointhit.png[title="Notificação de Nova Ocorrência de Ponto de Interrupção"]
...
image:debugging-current-suspended.png[title="Notificação de Nova Ocorrência de Ponto de Interrupção"]
...
image:debugging-editor-suspendedannot.png[title="Editor que mostra as anotações de depuração"]
...
image:debugging-editor-setcurrent.png[title="Editor mostrando a pop-up Definir como Thread Atual"]
...
image:debugging-thread-chooser.png[title="Aplicação Gallery"]
...
image:debugging-editor-suspendedannot2.png[title="Editor que mostra as anotações de depuração"]
...
image:debug-deadlock-setbkpt.png[title="Editor que mostra o ponto de interrupção definido na linha 20"]
...
image:debug-deadlock-resume.png[title="Retomando threads suspensos na janela Depuração"]
...
image:debug-deadlock-detected.png[title="Retomando threads suspensos na janela Depuração"]
