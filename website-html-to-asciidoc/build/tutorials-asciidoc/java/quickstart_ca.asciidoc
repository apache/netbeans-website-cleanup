...
:keywords: Apache NetBeans  quickstart_ca
:description: Apache NetBeans  quickstart_ca
:toc: left
:toc-title:
...
image:netbeans-stamp.gif[title="El contingut d'aquesta pàgina s'aplica a l'IDE NetBeans 6.5"]

* link:#setup[Configurant el projecte]
* link:#code[Afegint codi al fitxer font generat]
* link:#run[Compilant i executant l'aplicació]
* link:#build[Construint i desplegant l'aplicació]
* link:#nextsteps[Passos següents]
...
3. En l'assistent de Nou projecte, expandiu la categoria Java i seleccioneu Aplicació Java, tal com es mostra en la següent figura. Després cliqueu a Següent. image:proj-wizard.png[]
