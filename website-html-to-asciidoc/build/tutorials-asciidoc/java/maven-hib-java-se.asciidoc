...
:keywords: Apache NetBeans  maven-hib-java-se
:description: Apache NetBeans  maven-hib-java-se
:toc: left
:toc-title:
...
* link:#02[Configuring Maven]
* link:#02a[Viewing the Maven Repositories]
* link:#03[Creating the Maven Application]
* link:#03b[Modifying the Maven Project Properties]
* link:#04[Adding Hibernate Files and Dependencies]
* link:#04a[Creating the Hibernate Configuration File]
* link:#04b[Modifying the Hibernate Configuration File]
* link:#04c[Creating the `HibernateUtil.java` Helper File]
* link:#05[Generating Hibernate Mapping Files and Java Classes]
* link:#05a[Creating Hibernate Mapping Files and POJOs From a Database]
...
* link:#09[Running a Maven Project]
...
* link:http://books.sonatype.com/mvnref-book/reference/introduction.html[Chapter 1. Introducing Apache Maven] (from link:http://books.sonatype.com/mvnex-book/reference/public-book.html[Maven by Example])
