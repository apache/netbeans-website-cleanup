...
:keywords: Apache NetBeans  debug-visual_ja
:description: Apache NetBeans  debug-visual_ja
:toc: left
:toc-title:
...
* link:#Exercise_10[GUIスナップショットの作成]
* link:#Exercise_20[ビジュアル・デバッガの操作]
* link:#Exercise_21[ソースの検索]
* link:#Exercise_22[コンポーネント・イベントの調査]
...
link:debug-fullscreen.png[image:debug-fullscreen.png[title="クリックして拡大"]]
...
image:debug-snapshot.png[title="GUIスナップショット"]

また、IDEでは、コンポーネントの場所が「ナビゲータ」ウィンドウ内に階層形式で表示されます。

image:debug-navigator.png[title="GUIスナップショット"]
...
image:debug-gotodeclaration.png[title="コンポーネントが宣言されているコードの行"]
...
image:debug-gotosource.png[title="コンポーネントのソース・コードの行"]
...
image:debug-hierarchy.png[title="コンポーネントがコンテナに追加されているソース・コードの行"]
...
image:debug-customlisteners.png[title="コンポーネントがコンテナに追加されているソース・コードの行"]
...
image:debug-select-listener.png[title="コンポーネントがコンテナに追加されているソース・コードの行"]
...
image:debug-eventlog.png[title="コンポーネントがコンテナに追加されているソース・コードの行"]
