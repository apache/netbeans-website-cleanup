...
= hibernate-java-se_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  hibernate-java-se_pt_BR
:description: Apache NetBeans  hibernate-java-se_pt_BR
:toc: left
:toc-title:
...
* link:#02[Criando o Projeto da Aplicação Java Swing]
* link:#03[Adicionando o Suporte do Hibernate ao Projeto]
* link:#03a[Criando o Arquivo de Configuração do Hibernate]
* link:#03b[Modificando o Arquivo de Configuração do Hibernate]
* link:#03c[Criando o Arquivo de Ajuda `HibernateUtil.java`]
* link:#05[Gerando Arquivos de Mapeamento Hibernate e Classes Java]
* link:#05a[Criando o Arquivo de Engenharia Reversa]
* link:#05b[Criando Arquivos de Mapeamento Hibernate e POJOs Usando um Banco de Dados]
...
image:hib-libraries-config.png[title="Tela da janela Projetos mostrando bibliotecas do Hibernate"]
...
image:hib-util.png[title="O assistente Novo Arquivo que mostram como criar HibernateUtil"]
...
image:mapping-pojos-wizard-ant.png[title="Gerar assistente Arquivos de Mapeamento Hibernar e POJOs"]
