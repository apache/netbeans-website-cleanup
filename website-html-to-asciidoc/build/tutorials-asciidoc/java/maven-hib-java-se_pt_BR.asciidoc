...
= maven-hib-java-se_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  maven-hib-java-se_pt_BR
:description: Apache NetBeans  maven-hib-java-se_pt_BR
:toc: left
:toc-title:
...
* link:#02[Configurando o Maven]
* link:#02a[Exibindo os Repositórios Maven]
* link:#03[Criando a Aplicação Maven]
* link:#03b[Modificando as Propriedades do Projeto Maven]
* link:#04[Adicionando Arquivos e Dependências Hibernate]
* link:#04a[Criando o Arquivo de Configuração do Hibernate]
* link:#04b[Modificando o Arquivo de Configuração do Hibernate]
* link:#04c[Criando o Arquivo de Ajuda `HibernateUtil.java`]
* link:#05[Gerando Arquivos de Mapeamento Hibernate e Classes Java]
* link:#05a[Criando Arquivos de Mapeamento Hibernate e POJOs Usando um Banco de Dados]
* link:#06[Criando a GUI da Aplicação]
* link:#06a[Criando o Form JFrame]
* link:#06b[Adicionando Elementos ao Form]
* link:#07[Criando a Consulta no Editor de Consultas HQL]
* link:#08[Adicionando a Consulta ao Form]
* link:#09[Executando um Projeto Maven]
* link:#09a[Fazendo Download do Projeto da Solução]
* link:#10[Criando POJOs e Mapeando Arquivos Individualmente](Opcional)
...
* link:http://books.sonatype.com/mvnref-book/reference/introduction.html[Capítulo 1. Introdução ao Apache Maven] (do link:http://books.sonatype.com/mvnex-book/reference/public-book.html[Maven por Exemplo])
...
image:maven-repositories.png[title="Repositórios Maven na janela Serviços"]
...
image:maven-project-wizard.png[title="Arquétipos do Maven no assistente Novo Projeto"]
...
image:hib-config.png[title="Caixa de diálogo para selecionar conexão de banco de dados"]
...
image:maven-project-libs.png[title="Dependências no nó Bibliotecas na janela Projetos"]
...
image:maven-artifacts-viewer.png[title="A guia Gráficos ou o Visualizador do Artefato mostrando as dependências"]
...
image:add-property-factoryclass-4.png[title="Caixa de diálogo Adicionar Propriedade Hibernate que mostra o valor de definição de hibernate.query.factory_class"]
...
image:maven-hibutil-wizard.png[title="Assistente Util. Hibernate"]
...
*Observação.* Ao criar arquivos para múltiplas tabelas, você provavelmente desejará usar os assistentes. Neste tutorial, você só precisa criar um POJO e um arquivo de mapeamento, portanto, é muito mais fácil criar os arquivos individualmente. Você pode consultar as etapas para a link:#10[criação dos POJOs e arquivos de mapeamento individualmente] no final deste tutorial.
...
image:mapping-pojos-wizard.png[title="Gerar assistente Arquivos de Mapeamento Hibernar e POJOs"]
...
image:hib-jframe-form.png[title="Form GUI na View Design do editor"]
...
4. Teste a conexão inserindo `from Actor` no Editor de Consultas HQL. Clique no botão Executar Consulta HQL ( image:run_hql_query_16.png[title="Botão Executar Consulta HQL"] ) na barra de ferramentas.
...
image:hib-query-hqlresults.png[title="Hql Editor de Consulta mostrando resultados da consulta HQL"]
...
image:browse-main-class.png[title="Definindo a Classe Principal na caixa de diálogo Procurar Classes Principais"]
...
image:maven-projectproperties.png[title="Painel ações da janela propriedades do projeto DVDStoreAdmin"]
...
image:application-run.png[title="Aplicação Dvdstoreadmin mostrando os resultados"]
...
image:getters-setters.png[title="Caixa de diálogo Gerar Getters e Setters"]
...
image:mapping-wizard.png[title="Assistente Gerar Arquivos de Mapeamento de Hibernação"]
