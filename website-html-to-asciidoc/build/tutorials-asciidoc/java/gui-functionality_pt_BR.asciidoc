...
= gui-functionality_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  gui-functionality_pt_BR
:description: Apache NetBeans  gui-functionality_pt_BR
:toc: left
:toc-title:
...
* link:#Exercise_1[Exercício 1: Criando um Projeto]
* link:#Exercise_2[Exercício 2: Construindo o Front End]
* link:#Exercise_3[Exercício 3: Adicionando Funcionalidade]
* link:#Exercise_4[Exercício 4: Executando o Programa]
* link:#how[Como o Tratamento de Eventos Funciona]
...
*Observação:* a localização do diretório do projeto `NumberAddition` depende o caminho que você especificou ao criar o projeto na etapa 3 da seção link:#Exercise_1[Exercício 1: Criando um Projeto].
