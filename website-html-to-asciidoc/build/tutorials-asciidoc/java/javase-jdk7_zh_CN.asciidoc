...
:keywords: Apache NetBeans  javase-jdk7_zh_CN
:description: Apache NetBeans  javase-jdk7_zh_CN
:toc: left
:toc-title:
...
* link:#platform[确保在 IDE 中注册 JDK 7]
* link:#project[检查项目配置]
* link:#switch[使用新的 JDK 7 语言结构：Switch 语句]
* link:#more[JDK 7 支持：更多示例]
* link:#see[后续步骤]
