...
:keywords: Apache NetBeans  gui-binding_pt_BR
:description: Apache NetBeans  gui-binding_pt_BR
:toc: left
:toc-title:
...
image:netbeans-stamp-80-74-73.png[title="O conteúdo desta página se aplica ao NetBeans IDE 7.1, 7.2, 7.3, 7.4 e 8.0"]

* link:#intro[Introdução: Vinculação de Beans no NetBeans IDE]
* link:#prop-binding[Vinculando Propriedades a Outras Propriedades]
* link:#prop-custom[Vinculando Beans Personalizados]
* link:#prop-advanced[Propriedades de Vinculação Avançadas]
* link:#data-binding[Vinculando Dados aos Componentes]
* link:#prop-synth[Propriedades de Vinculação Especiais]
