...
:keywords: Apache NetBeans  jmx-getstart_pt_BR
:description: Apache NetBeans  jmx-getstart_pt_BR
:toc: left
:toc-title:
...
image:jmx-newfile.png[title="Assistentes de Novo Arquivo na categoria JMX"]
...
|image:run-project24.png[title="Botão Executar Projeto Principal com Monitoramento e Gerenciamento"] |Executar Projeto Principal com Monitoramento e Gerenciamento 

|image:debug-project24.png[title="Botão Depurar Projeto Principal com Monitoramento e Gerenciamento"] |Depurar Projeto Principal com Monitoramento e Gerenciamento 

|image:console24.png[title="Botão Iniciar Console de Gerenciamento de JConsole"] |Iniciar Console de Gerenciamento de JConsole 
|===
...
image:jmx-jconsole1.png[title="Janela JConsole"]
...
image:jmx-jconsole2.png[title="Janela de JConsole mostrando valores atualizados"]
