...
= jmx-manager-tutorial_ru
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  jmx-manager-tutorial_ru
:description: Apache NetBeans  jmx-manager-tutorial_ru
:toc: left
:toc-title:
...
* link:#Exercise_1[Создание проекта демонстрационного управляющего приложения Anagram]
* link:#Exercise_2[Запуск агента]
* link:#Exercise_3[Создание проекта диспетчера]
* link:#Exercise_3[Создание проекта]
* link:#Exercise_4[Создание выполняемого класса диспетчера]
* link:#Exercise_5[Запуск диспетчера]
...
image:jmx-newproject.png[title="Проект 'Игра Anagram под управлениемJMX' в мастере создания проектов"]
...
image:jmx-properties1.png[title="Категория 'Мониторинг и управление' в диалоговом окне свойств проекта"]
...
Также можно нажать кнопку 'Запуск основного проекта с функциями мониторинга и управления' на панели инструментов (  image:run-project24.png[title="Кнопка 'Запуск основного проекта с функциями мониторинга и управления'"]).
...
image:jmx-newjavaproject.png[title="Мастер создания проектов Java"]
...
image:jmx-newjmxmanager.png[title="Шаблон диспетчера JMX в мастере создания файлов"]
...
image:jmx-jmxagenturl.png[title="параметры по умолчанию в диалоговом окне 'URL-адрес агента RMI JMX'"]
...
link:jmx-jmxagenturl2.png[image:jmx-jmxagenturl2-sm.png[title="Щелкните для увеличения"]]
