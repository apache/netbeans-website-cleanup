...
:keywords: Apache NetBeans  wish-list-lesson3
:description: Apache NetBeans  wish-list-lesson3
:toc: left
:toc-title:
...
* link:#addLinkNewWisher[Adding a Link to Start Creating a New Wisher]
* link:#implementCreateNewWisher[Creating New PHP Web Pages]
* link:#inputFormNewWisher[Adding an HTML Form for Entering the Data of a New Wisher]
* link:#validatinDataBeforeAddingToDatabase[Validating Data and Adding It to the Database]
* link:#errorMessagesInInputForm[Displaying Error Messages in the Input Form]
* link:#testCreateNewWisherFunctionality[Testing the Create New Wisher Functionality]
...
1. link:#addLinkNewWisher[The user opens the front page index.php and clicks the link to register].

2. link:#implementCreateNewWisher[The user switches to the createNewWisher.php page for creating a new wisher].
...
Now you implement the display of error messages when the entered data is invalid. The implementation is based on the validations and changes to the values of the boolean variables described in link:#validatinDataBeforeAddingToDatabase[Validating Data and Adding It to the Database].
