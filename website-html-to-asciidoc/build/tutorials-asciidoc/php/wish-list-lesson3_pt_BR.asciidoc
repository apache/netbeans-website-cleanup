...
= wish-list-lesson3_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  wish-list-lesson3_pt_BR
:description: Apache NetBeans  wish-list-lesson3_pt_BR
:toc: left
:toc-title:
...
* link:#addLinkNewWisher[Adicionando um Link para Começar a Criar um Novo Wisher]
* link:#implementCreateNewWisher[Criando Novas Páginas Web de PHP]
* link:#inputFormNewWisher[Adicionando um Form HTML para Inserir os Dados de um Novo Wisher]
* link:#validatinDataBeforeAddingToDatabase[Validando Dados e Adicionando-os ao Banco de Dados]
* link:#errorMessagesInInputForm[Exibindo Mensagens de Erro no Form de Entrada]
* link:#testCreateNewWisherFunctionality[Testando a Funcionalidade de Criação do Novo Wisher]
...
1. link:#addLinkNewWisher[O usuário abre a página inicial index.php e clica no link para registrar].

2. link:#implementCreateNewWisher[O usuário alterna para a página createNewWisher.php para criar um novo wisher].
...
Agora você deve implementar a exibição das mensagens de erro quando os dados inseridos forem inválidos. A implementação é baseada nas validações e alterações nos valores das variáveis boolianas descritas em link:#validatinDataBeforeAddingToDatabase[Validando Dados e Adicionando-os ao Banco de Dados].
