...
* link:#business[Creating the Business Logic]
...
link:php-run-config.png[image:php-run-config.png[title="Click to Enlarge"]]
...
12. Run the project to see what it looks like in a browser. Click the Run Project ( image:run-project-btn.png[] ) button. The `index.html` file displays in your default browser.
