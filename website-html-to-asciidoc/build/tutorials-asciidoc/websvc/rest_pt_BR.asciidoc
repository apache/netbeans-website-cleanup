...
:keywords: Apache NetBeans  rest_pt_BR
:description: Apache NetBeans  rest_pt_BR
:toc: left
:toc-title:
...
* link:#entity-classes[Web Services RESTful, persistência e Classes de Entidade]
* link:#create-services-from-db[Criando Web Services RESTful de um Banco de dados]
* link:#create-project[Criando o Projeto]
* link:#entities-and-services[Gerando Classes de Entidade e Serviços RESTful]
* link:#test-rest[Testando os Web Services RESTful]
...
image:select-tables.png[title="Painel Tabelas de Bancos de Dados do assistente Novas Classes de Entidade do Banco de Dados que mostra as tabelas CUSTOMER e DISCOUNT_CODE selecionadas"]
...
image:test-rest1.png[title="Página inicial de testes do Web service RESTful no browser"]
