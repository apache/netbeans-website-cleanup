...
:keywords: Apache NetBeans  jax-ws_ja
:description: Apache NetBeans  jax-ws_ja
:toc: left
:toc-title:
...
* link:#Exercise_1[Webサービスの作成]
* link:#Exercise_2[Webサービスの設計]
* link:#Exercise_2_1[Webサービスのデプロイおよびテスト]
* link:#samples[サンプル]
* Webサービスの使用
* link:#Exercise_3_1[Java SEアプリケーションのJavaクラス]
* link:#Exercise_3_2[Webアプリケーションのサーブレット]
* link:#Exercise_3_3[WebアプリケーションのJSPページ]
...
image:design-view-with-op.png[title="追加した操作が表示されたWebサービスのビジュアル・デザイナ"]
