...
:keywords: Apache NetBeans  java-card_pt_BR
:description: Apache NetBeans  java-card_pt_BR
:toc: left
:toc-title:
...
* link:#reqs[Software e Hardware Necessários]
* link:#setup[Configurando o Ambiente do Projeto]
* link:#types[Entendendo os Tipos de Projeto do Java Card]
* link:#projects[Trabalhando Com um Projeto]
* link:#special[Utilizando Funcionalidades Especiais de Plug-in]
* link:#sdk[Integrando SDKs de Terceiros]
* link:#related[Links Relacionados]

=== Requisitos

*Para concluir este tutorial, são necessários os seguintes recursos e softwares:*

image:netbeans-stamp.gif[title="O conteúdo desta página aplica-se ao NetBeans IDE 6.8 e 6.9"]
