...
= cordova-gettingstarted_ru
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  cordova-gettingstarted_ru
:description: Apache NetBeans  cordova-gettingstarted_ru
:toc: left
:toc-title:
...
image:netbeans-stamp.png[title="Содержимое этой страницы применимо к IDE NetBeans 7.3"]

* link:#installcordova[Установка Cordova]
* link:#createproject[Создание проекта HTML5 Cordova]
* link:#editapp[Изменение исходного кода]
* link:#edithtml[Редактирование файла HTML]
* link:#editconfig[Изменение конфигурации Cordova]
* link:#editjs[Редактирование файла JavaScript]
...
image:cordova-newproject-wizard1.png[title="Шаблон приложения Cordova в мастере создания проектов"]
...
image:cordova-newproject-wizard2.png[title="Панель шаблонов сайта в мастере создания приложений HTML5"]
...
image:cordova-newproject-wizard3.png[title="Панель 'Библиотеки JavaScript' в мастере создания приложений HTML5"]
...
image:cordova-projects-window1.png[title="Окно проектов"]
...
image:cordova-select-browser.png[title="Браузер, выбранный в раскрывающемся списке на панели инструментов."]
...
image:cordova-ios7-run.png[title="Приложение в симуляторе iOS"]
...
image:cordova-code-completion.png[title="Автозавершение кода в редакторе"]
...
image:cordova-properties-application.png[title="Вкладка 'Подключаемые модули Cordova' в окне 'Свойства проекта'"]
...
image:cordova-properties-plugins.png[title="Вкладка 'Подключаемые модули Cordova' в окне 'Свойства проекта'"]
...
image:cordova-ios7-run1.png[title="Запрос местоположения в приложении"]
...
image:cordova-ios-customlocation.png[title="Диалоговое окно 'Пользовательское местоположение' в симуляторе iOS"]
...
image:cordova-ios7-run3.png[title="Приложение при использовании текущего местоположения в симуляторе iOS"]
...
image:cordova-debug-breakpoint1.png[title="Отладчик остановился по достижении точки останова"]
...
image:cordova-debug-variables1b.png[title="Подсказка с переменными"]

Если навести курсор на переменную `position` или `coords` появится стрелка, которую можно нажать, чтобы развернуть подсказку.

image:cordova-debug-variables1a.png[title="Подсказка с переменными"]

Развернутая подсказка позволяет просматривать значения более подробно.

image:cordova-debug-variables2.png[title="Подсказка с переменными"]
...
image:cordova-debug-variables.png[title="Окно &quot;Переменные&quot;"]

В окне 'Сетевой монитор' отображается список запросов приложения.

image:cordova-network-monitor.png[title="Окно &quot;Переменные&quot;"]
