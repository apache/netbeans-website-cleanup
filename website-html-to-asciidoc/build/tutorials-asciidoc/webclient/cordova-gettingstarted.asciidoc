...
= cordova-gettingstarted
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  cordova-gettingstarted
:description: Apache NetBeans  cordova-gettingstarted
:toc: left
:toc-title:
...
image:netbeans-stamp.png[title="Content on this page applies to the NetBeans IDE 7.3"]

* link:#installcordova[Installing Cordova]
* link:#createproject[Creating a Cordova HTML5 Project]
* link:#editapp[Modifying the Source Code]
* link:#edithtml[Editing the HTML File]
* link:#editconfig[Modifying the Cordova Configuration]
* link:#editjs[Editing the JavaScript File]
