...
= cordova-gettingstarted_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  cordova-gettingstarted_pt_BR
:description: Apache NetBeans  cordova-gettingstarted_pt_BR
:toc: left
:toc-title:
...
image:netbeans-stamp.png[title="O conteúdo desta página se aplica ao NetBeans IDE 7.3"]

* link:#installcordova[Instalando o Cordova]
* link:#createproject[Criando um Projeto Cordova HTML5]
* link:#editapp[Modificando o Código-fonte]
* link:#edithtml[Editando o Arquivo HTML]
* link:#editconfig[Modificando a Configuração do Cordova]
* link:#editjs[Editando o Arquivo JavaScript]
...
image:cordova-newproject-wizard1.png[title="Modelo de Aplicação Cordova no assistente de Novo Projeto"]
...
image:cordova-newproject-wizard2.png[title="Painel Modelos de Site no assistente da Nova Aplicação em HTML5"]
...
image:cordova-newproject-wizard3.png[title="Painel Bibliotecas de JavaScript no assistente da Nova Aplicação em HTML5"]
...
image:cordova-projects-window1.png[title="Janela Projetos"]
...
image:cordova-select-browser.png[title="Browser selecionado na lista drop-down na barra de ferramentas"]
...
image:cordova-ios7-run.png[title="Aplicação no Simulador do iOS"]
...
image:cordova-code-completion.png[title="Autocompletar código no editor"]
...
image:cordova-properties-application.png[title="A guia Plug-ins do Cordova na janela Propriedades do Projeto"]
...
image:cordova-properties-plugins.png[title="A guia Plug-ins do Cordova na janela Propriedades do Projeto"]
...
image:cordova-ios7-run1.png[title="Prompt de localização na aplicação"]
...
image:cordova-ios-customlocation.png[title="Caixa de diálogo Localização Personalizada no Simulador do iOS"]
...
image:cordova-ios7-run3.png[title="Aplicação ao usar uma localização personalizada no Simulador do iOS"]
...
image:cordova-debug-breakpoint1.png[title="Depurador interrompido no ponto de interrupção"]
...
image:cordova-debug-variables1b.png[title="Dica de ferramenta mostrando variáveis"]
...
image:cordova-debug-variables1a.png[title="Dica de ferramenta mostrando variáveis"]

A dica de ferramenta expandida permite que você veja os valores com mais detalhes.

image:cordova-debug-variables2.png[title="Dica de ferramenta mostrando variáveis"]
...
image:cordova-debug-variables.png[title="Janela Variáveis"]

Na janela Monitor de Rede, você vê uma lista das solicitações da aplicação.

image:cordova-network-monitor.png[title="Janela Variáveis"]
