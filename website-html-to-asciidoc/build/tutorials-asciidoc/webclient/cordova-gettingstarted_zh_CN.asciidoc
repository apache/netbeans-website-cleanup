...
= cordova-gettingstarted_zh_CN
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  cordova-gettingstarted_zh_CN
:description: Apache NetBeans  cordova-gettingstarted_zh_CN
:toc: left
:toc-title:
...
image:netbeans-stamp.png[title="此页上的内容适用于 NetBeans IDE 7.3"]

* link:#installcordova[安装 Cordova]
* link:#createproject[创建 Cordova HTML5 项目]
* link:#editapp[修改源代码]
* link:#edithtml[编辑 HTML 文件]
* link:#editconfig[修改 Cordova 配置]
* link:#editjs[编辑 JavaScript 文件]
* link:#debug[调试应用程序]
* link:#summary[小结]
* link:#seealso[另请参见]
...
image:cordova-newproject-wizard1.png[title="新建项目向导中的 Cordova 应用程序模板"]
...
image:cordova-newproject-wizard2.png[title="&quot;New HTML5 Application&quot;（新建 HTML5 应用程序）向导中的 &quot;Site Templates&quot;（站点模板）面板"]
...
image:cordova-newproject-wizard3.png[title="&quot;New HTML5 Application&quot;（新建 HTML5 应用程序）向导中的 &quot;JavaScript Libraries&quot;（JavaScript 库）面板"]
...
image:cordova-projects-window1.png[title="&quot;Projects&quot;（项目）窗口"]
...
image:cordova-select-browser.png[title="在工具栏下拉列表中选择的浏览器"]
8. 单击工具栏中的 "Run"（运行）图标。

选择 "Run"（运行）时，IDE 会将 Cordova 应用程序部署到仿真器。

image:cordova-ios7-run.png[title="iOS 模拟程序中的应用程序"]
...
image:cordova-code-completion.png[title="编辑器中的代码完成功能"]
...
2. 在类别列表中选择 *Cordova*。
image:cordova-properties-application.png[title="&quot;Project Properties&quot;（项目属性）窗口中的 &quot;Cordova Plugins&quot;（Cordova 插件）标签"]
...
image:cordova-properties-plugins.png[title="&quot;Project Properties&quot;（项目属性）窗口中的 &quot;Cordova Plugins&quot;（Cordova 插件）标签"]
...
image:cordova-debug-breakpoint1.png[title="在断点处停止的调试器"]

如果您将光标悬停在变量上方，则可以看到显示变量的相关详细信息的工具提示。如果光标位于 `latitude` 变量上方，则此变量的值将显示在工具提示中。

image:cordova-debug-variables1b.png[title="显示变量的工具提示"]

如果光标位于 `position` 或 `coords` 上方，则工具提示将包含一个箭头，您可以单击此箭头展开工具提示。

image:cordova-debug-variables1a.png[title="显示变量的工具提示"]

您可以在展开的工具提示中更详细地查看值。

image:cordova-debug-variables2.png[title="显示变量的工具提示"]

在这种情况下，更易于查看 "Variables"（变量）窗口中的值。在 "Variables"（变量）窗口中，可以查看您的当前位置的纬度和经度。

image:cordova-debug-variables.png[title="&quot;Variables&quot;（变量）窗口"]

在 "Network Monitor"（网络监视器）窗口中，您可以查看应用程序请求的列表。

image:cordova-network-monitor.png[title="&quot;Variables&quot;（变量）窗口"]
