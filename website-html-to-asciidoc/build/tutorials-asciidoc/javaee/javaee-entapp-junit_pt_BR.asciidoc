...
= javaee-entapp-junit_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  javaee-entapp-junit_pt_BR
:description: Apache NetBeans  javaee-entapp-junit_pt_BR
:toc: left
:toc-title:
...
* link:#Exercise_1[Testando um Bean de Sessão]
* link:#Exercise_1a[Criando o Projeto]
* link:#Exercise_1b[Criando o Bean de Sessão]
* link:#Exercise_1c[Testando o Bean de Sessão]
* link:#Exercise_1d[Modificando o Teste para Especificar Propriedades do Container]
* link:#Exercise_1e[Usando Anotações @BeforeClass e @AfterClass]
* link:#Exercise_2[Testando uma Classe de Entidade]
* link:#Exercise_2a[Criando a Classe de Entidade]
* link:#Exercise_2b[Modificando o Bean de Sessão]
* link:#Exercise_2c[Testando a Classe de Entidade]
* link:#Exercise_3[Fazendo Download do Projeto da Solução]
...
image:create-tests-dialog.png[title="Caixa de diálogo Criar Testes"]
...
image:embedded-static-shell-jar.png[title="Estrutura do projeto na janela Projetos"]
...
image:test-results1.png[title="Janela Resultados do Teste"]
...
image:test-results2a.png[title="Janela Resultados do Teste"]
...
image:create-entity-wizard.png[title="Caixa de diálogo Criar Classe de Entidade"]
...
image:test-results2b.png[title="A janela Resultados do Teste depois da adição do teste testInsert"]
