...
:keywords: Apache NetBeans  entappclient
:description: Apache NetBeans  entappclient
:toc: left
:toc-title:
...
* link:#Exercise_10[Creating the Java Class Library]
* link:#Exercise_20[Creating an EJB Module]
* link:#Exercise_22[Creating the Session Bean]
* link:#Exercise_23[Adding a Business Method]
* link:#Exercise_24[Deploying the Enterprise Application]
* link:#Exercise_30[Creating the Application Client]
* link:#Exercise_32[Adding the Class Library]
* link:#Exercise_30[Running the Application Client]
