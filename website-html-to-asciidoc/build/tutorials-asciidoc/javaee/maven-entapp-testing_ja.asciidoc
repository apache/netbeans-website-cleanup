...
= maven-entapp-testing_ja
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  maven-entapp-testing_ja
:description: Apache NetBeans  maven-entapp-testing_ja
:toc: left
:toc-title:
...
* link:#Exercise_1[エンタープライズ・アプリケーションの作成]
* link:#Exercise_1a[Webプロジェクトの作成]
* link:#Exercise_1b[エンティティ・クラスの作成]
* link:#Exercise_1c[セッションBeanの作成]
* link:#Exercise_2[セッションBeanテストの作成]
...
image:maven-testing-projects.png[title="生成されたプロジェクトを示す「プロジェクト」ウィンドウ"]
...
image:maven-testing-pu.png[title="生成されたプロジェクトを示す「プロジェクト」ウィンドウ"]
...
image:maven-testing-createconstructor.png[title="生成されたプロジェクトを示す「プロジェクト」ウィンドウ"]
...
image:maven-testing-fiximports.png[title="生成されたプロジェクトを示す「プロジェクト」ウィンドウ"]
...
image:add-shell-dependency.png[title="「テスト結果」ウィンドウ"]
...
image:maven-test-results.png[title="「テスト結果」ウィンドウ"]

「テスト結果」ウィンドウで、「成功したものを表示」アイコン(image:test-ok_16.png[title="「成功したものを表示」アイコン"])をクリックして、成功したすべてのテストのリストを表示できます。この例では、9個のテストに成功したことがわかります。「出力」ウィンドウを見ると、1個のテストのみが実行され、8個のテストがスキップされたことを確認できます。スキップされたテストは、「テスト結果」ウィンドウの成功したテストのリストに含まれます。
