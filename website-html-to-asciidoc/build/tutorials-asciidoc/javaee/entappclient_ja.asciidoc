...
:keywords: Apache NetBeans  entappclient_ja
:description: Apache NetBeans  entappclient_ja
:toc: left
:toc-title:
...
* link:#Exercise_10[Javaクラス・ライブラリの作成]
* link:#Exercise_20[EJBモジュールの作成]
* link:#Exercise_22[セッションBeanの作成]
* link:#Exercise_23[ビジネス・メソッドの追加]
* link:#Exercise_24[エンタープライズ・アプリケーションのデプロイ]
* link:#Exercise_30[アプリケーション・クライアントの作成]
* link:#Exercise_32[クラス・ライブラリの追加]
* link:#Exercise_30[アプリケーション・クライアントの実行]
...
image:appclient-newclasslibrary.png[title="新規クラス・ライブラリ・プロジェクト・ウィザード"]
...
image:appclient-newentappejb.png[title="新規エンタープライズ・アプリケーション・ウィザードで「EJBモジュールの作成」が選択されている"]
...
image:appclient-projects-entappejb1.png[title="開いているプロジェクトを示す「プロジェクト」ウィンドウ"]
...
image:appclient-wizard-newsessionbean.png[title="新規セッションBeanウィザード"]
...
image:appclient-projects-entappejb2.png[title="セッションBeanとリモート・インタフェースを示す「プロジェクト」ウィンドウ"]
...
image:appclient-wizard-newentappclient.png[title="「新規プロジェクト」で選択したアプリケーション・クライアントの作成"]
...
image:appclient-callenterprise.png[title="「エンタープライズBeanをコール」ダイアログ"]
...
image:appclient-buildoutput.png[title="「出力」ウィンドウの結果"]
