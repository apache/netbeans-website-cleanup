...
= javaee-gettingstarted_pt_BR
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  javaee-gettingstarted_pt_BR
:description: Apache NetBeans  javaee-gettingstarted_pt_BR
:toc: left
:toc-title:
...
* link:#Exercise_2[Criando a Classe de Entidade e a Fachada de Sessão]
* link:#Exercise_2a[Criando a Classe de Entidade]
* link:#Exercise_2b[Criando a Fachada da Sessão]
* link:#Exercise_3[Criando as Páginas Bean Gerenciado JSF e JSF]
* link:#Exercise_3a[Criando o Bean Gerenciado]
* link:#Exercise_3b[Modificando a Página de Índice]
* link:#Exercise_3c[Criando a Página de Resultados]
...
image:newappwizard.png[title="Painel Servidor e Definições no assistente Novo Projeto"]
...
image:newappwizard2.png[title="Painel Frameworks no assistente Novo Projeto"]
...
image:getters-dialog.png[title="Assistente Criar Unidade de Persistência"]
...
image:sessionwizard.png[title="Assistente Beans de Sessão para Classes de Entidade"]
...
image:newjsfbean.png[title="Novo assistente de Bean Gerenciado pelo JSF"]
...
image:projectswindow.png[title="Janela Projeto que mostra estrutura de arquivos"]
...
image:callbean.png[title="Caixa de diálogo Chamar Enterprise Bean"]
...
image:jsfcodecompletion1.png[title="Autocompletar código no editor de código-fonte"]
...
image:result-jsf-page.png[title="Criando o arquivo JSF theend no assistente Novo Arquivo JSF"]
...
image:browser1.png[title="Aplicação no browser"]
...
image:browser2.png[title="Aplicação no browser mostrando resultados"]
