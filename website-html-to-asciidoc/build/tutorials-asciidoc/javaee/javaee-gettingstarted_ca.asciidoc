...
= javaee-gettingstarted_ca
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  javaee-gettingstarted_ca
:description: Apache NetBeans  javaee-gettingstarted_ca
:toc: left
:toc-title:
...
image:netbeans-stamp-71-72.gif[title="El contingut d'aquesta pàgina s'aplica al IDE NetBeans 7.1"]

* link:#Exercise_1[Creant el projecte d'aplicació Web]
* link:#Exercise_2[Creant la classe d'entitat i la part frontal de la sessió]
* link:#Exercise_2a[Creant la classes d'entitat]
* link:#Exercise_2b[Creant la part frontal de la sessió]
* link:#Exercise_3[Creant el Bean gestionat JSF i les pàgines JSF]
* link:#Exercise_3a[Creant el Bean gestionat]
* link:#Exercise_3b[Modificant la pàgina d'índex]
* link:#Exercise_3c[Creant la pàgina de resultats]
* link:#Exercise_4[Executant el projecte]
...
image:newappwizard.png[title="panell servidor i preferències en l'assistent de nou projecte"]
...
image:newappwizard2.png[title="panell Frameworks en l'assistent de nou projecte"]
...
image:getters-dialog.png[title="Assistent crear unitat de persistència"]
...
image:sessionwizard.png[title="Assistent Beans de sessió per a classes d'entitat"]
...
image:newjsfbean.png[title="Nou assistent Bean gestionat per JSF"]
...
image:projectswindow.png[title="Finestra de projecte mostrant l'estructura de fitxers"]
...
image:callbean.png[title="Diàleg Cridar Bean empresarial,"]
...
image:jsfcodecompletion1.png[title="Auto-completat de codi en l'editor de codi"]
