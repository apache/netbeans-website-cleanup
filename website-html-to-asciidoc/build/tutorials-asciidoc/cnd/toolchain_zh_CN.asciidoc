...
:keywords: Apache NetBeans  toolchain_zh_CN
:description: Apache NetBeans  toolchain_zh_CN
:toc: left
:toc-title:
...
* link:#intro[简介]
* link:#tool[工具集合]
* link:#community[社区提供的工具集合]
* link:#edit[编辑工具集合描述符]
* link:#create[创建定制工具集合]
* link:#details[工具集合 XML 文件的详细信息]
* link:#provider[创建定制编译器提供器]
* link:#errorhandler[创建定制编译器错误处理程序]
...
有关这些描述符 XML 文件中使用的标记的信息，请参见link:#details[工具集合 XML 文件的详细信息]。可以更改标记的值以更改 IDE 中工具的行为。
...
image:options.png[title=""Options"（选项）面板"]
...
|scanner |错误解析器服务的名称，请参见link:#errorhandler[创建定制编译器错误处理程序] 
