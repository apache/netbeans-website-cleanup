...
= development-environment_ja
:jbake-type: page
:jbake-tags: old-site, needs-review
:jbake-status: published
:keywords: Apache NetBeans  development-environment_ja
:description: Apache NetBeans  development-environment_ja
:toc: left
:toc-title:
...
* link:#installing[ツール・コレクションのインストール]
* link:#host[ビルド・ホストの指定]
* link:#using[ツール・コレクション・リストの使用]
* link:#changing[プロジェクトのツール・コレクションの変更]
