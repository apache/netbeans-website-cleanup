...
image:netbeans-stamp-80-74-73.png[title="此页上的内容适用于 NetBeans IDE 7.2 及更高版本"]

* link:#requirements[要求]
* link:#projects[创建 C 和 C++ 项目]
* link:#running[运行项目]
* link:#existingsourcesprojects[创建基于现有源代码的 C/C++ 项目]
* link:#frombinaryprojects[创建基于二进制文件的 C/C++ 项目]
* link:#nextsteps[后续步骤]
