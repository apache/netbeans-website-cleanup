...
:keywords: Apache NetBeans  cpp-vcs_zh_CN
:description: Apache NetBeans  cpp-vcs_zh_CN
:toc: left
:toc-title:
...
* link:#issue[NetBeans IDE 中已解决的 VCS 控制的项目问题]
* link:#unfriendly[VCS 不友好的项目数据存储]
* link:#compiler[编译器选项]
* link:#variables[环境变量列表]
* link:#cannotbuild[无法构建项目时配置代码帮助]
* link:#macros[瞬态宏]
* link:#prj[受管项目]
* link:#info[有关 C/C++/Fortran 支持的更多信息]
