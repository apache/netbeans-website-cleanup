...
image:netbeans-stamp-80-74-73.png[title="O conteúdo desta página se aplica ao NetBeans IDE 7.2 e mais recente"]

* link:#requirements[Requisitos]
* link:#projects[Criando Projetos em C e C++]
* link:#running[Executando um Projeto]
* link:#existingsourcesprojects[Criando um Projeto C/C++ com Códigos-fonte Existentes]
* link:#frombinaryprojects[Criando um Projeto C/C ++ de um Arquivo Binário]
